...
int Application::Point(vect4 & v1, vect4 & v2)
{
	int a;
	a = v1.v[0] * v2.v[0] + (v1.v[1] * v2.v[1] + (v1.v[2] * v1.v[2]));
	return a;
}
...
void Application::update()
{
	...
	eye = vect4(15.0, 15.0, 15.0);
	target = vect4(0.0, 0.0, 0.0);
	up = vect4(0.0, 1.0, 0.0);
	//Aqui los parametros deben ser Ojo, Target, Up
	Mat4 Look = LookAt(eye, target, up); //Solo recibe 3 
	...
	Mat4 Final1 = Look*RotY*RotX * Trans1;
	verticesF.clear();
